    ...
    <div class="teamBottom">
        ...
        <div class="pageWidth" v-if="activeTab === 2" transition="slideFade">
            <div class="leftSide">
                ...
                <a class="expertLink" href="https://blog.prototypr.io/this-is-exactly-how-much-it-costs-to-make-an-app-8a669f77a6a7" target="_blank" rel="noopener noreferrer"><span>Read:</span> This is exactly how much it costs to build an app</a>
                <a class="expertLink" href="https://blog.prototypr.io/my-personal-pillars-of-ux-design-12ead9af0300" target="_blank" rel="noopener noreferrer"><span>Read:</span> My personal pillars of UX design</a>
            </div>
            <div class="rightSide">
