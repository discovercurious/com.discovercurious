  ...
  <div id="app">
    ...
    <section class="studySection s-ImageGroup bg-ltGray">
      <div class="pageWidth">
          ...
          <div class="col2">
            <div class="col">
              <div class="responsiveImage" v-lazy:background-image="require('~/static/casestudies/alomereBrand/4.jpg')"></div>
            </div>
            <div class="col">
              <div class="responsiveImage" v-lazy:background-image="require('~/static/casestudies/alomereBrand/5.jpg')"></div>
            </div>
          </div>
      </div>
    </section>
    ...
    <section id="cta">
      <div class="pageWidth">
        <div class="ctaText">
          <span>CNeed help building consensus within a large organization?</span> <nuxt-link class="button" to="/#contact">Get in touch</nuxt-link>
        </div>
      </div>
    </section>
  </div>
